# WNG Numeric Sequence App

This project is a numeric sequencer that takes one input value and displays 5 sequences starting from the value 1 up to and including the inputted value. The following numeric sequences shall be displayed:
...
### Clone wng_numeric_sequence

Clone the wng_numeric_sequence repository using [git][git]:

```
git clone https://github.com/mpal035/wng_numeric_sequence.git
cd wng_numeric_sequence
```
